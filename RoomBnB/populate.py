...
Room(description="Habitacion con  armario", price=300, picture="",temporal_owner=8,belong_to_id=2)
...
Room(description="Habitacion tematica ", price=270, picture="",belong_to_id=5)
...
Room(description="Habitacion simple", price=245, picture="",belong_to_id=7)
Room(description="Habitacion hogareña", price=245, picture="",belong_to_id=7)
...
FlatImage(flat_id=1, image="/ISPP/static/fotos/piso1.jpg")
FlatImage(flat_id=2, image="/ISPP/static/fotos/piso2.jpg")
FlatImage(flat_id=3, image="/ISPP/static/fotos/piso3.jpg")
FlatImage(flat_id=4, image="/ISPP/static/fotos/piso4.jpg")
FlatImage(flat_id=5, image="/ISPP/static/fotos/piso5.jpg")
FlatImage(flat_id=6, image="/ISPP/static/fotos/piso6.jpg")
FlatImage(flat_id=7, image="/ISPP/static/fotos/piso7.jpg")
FlatImage(flat_id=8, image="/ISPP/static/fotos/piso8.jpg")


RoomImage.objects.all().delete()
RoomImage(room_id=1,image="/ISPP/static/fotos/habitacion2.jpg")
RoomImage(room_id=2,image="/ISPP/static/fotos/habitacion1.jpg")
RoomImage(room_id=3,image="/ISPP/static/fotos/habitacion4.jpg")
RoomImage(room_id=4,image="/ISPP/static/fotos/habitacion6.jpg")
RoomImage(room_id=5,image="/ISPP/static/fotos/habitacion11.jpg")
RoomImage(room_id=6,image="/ISPP/static/fotos/habitacion5.jpg")
RoomImage(room_id=7,image="/ISPP/static/fotos/habitacion3.jpg")
RoomImage(room_id=8,image="/ISPP/static/fotos/habitacion8.jpg")
RoomImage(room_id=9,image="/ISPP/static/fotos/habitacion9.jpg")
RoomImage(room_id=10,image="/ISPP/static/fotos/habitacion16.jpg")
RoomImage(room_id=11,image="/ISPP/static/fotos/habitacion10.jpg")
RoomImage(room_id=12,image="/ISPP/static/fotos/habitacion7.jpg")
RoomImage(room_id=13,image="/ISPP/static/fotos/habitacion12.jpg")
RoomImage(room_id=14,image="/ISPP/static/fotos/habitacion13.jpg")
RoomImage(room_id=15,image="/ISPP/static/fotos/habitacion14.jpg")
RoomImage(room_id=16,image="/ISPP/static/fotos/habitacion15.jpg")
